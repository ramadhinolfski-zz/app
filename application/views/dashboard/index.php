			...
			<ul class="list divider-full-bleed">
				<li class="tile">
					<div class="tile-content">
						<div class="tile-icon">
							<img src="<?php echo base_url(); ?>/theme/img/avatar9.jpg?1404026744" alt="" />
						</div>
				...
				<li class="tile">
					<div class="tile-content">
						<div class="tile-icon">
							<img src="<?php echo base_url(); ?>/theme/img/avatar4.jpg?1404026791" alt="" />
						</div>
				...
				<li class="tile">
					<div class="tile-content">
						<div class="tile-icon">
							<img src="<?php echo base_url(); ?>/theme/img/avatar11.jpg?1404026774" alt="" />
						</div>
				...
				<li class="tile">
					<div class="tile-content">
						<div class="tile-icon">
							<img src="<?php echo base_url(); ?>/theme/img/avatar7.jpg?1404026721" alt="" />
						</div>
				...
				<li class="tile">
					<div class="tile-content">
						<div class="tile-icon">
							<img src="<?php echo base_url(); ?>/theme/img/avatar8.jpg?1404026729" alt="" />
						</div>
				...
				<li class="tile">
					<div class="tile-content">
						<div class="tile-icon">
							<img src="<?php echo base_url(); ?>/theme/img/avatar2.jpg?1404026449" alt="" />
						</div>
